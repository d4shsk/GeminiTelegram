...
GROQ_TOOLS = [
    {
        ...
        "function": {
            ...
            "description": "Искать информацию в интернете (DuckDuckGo). Используй это для поиска новостей, актуальной информации или ответов на вопросы, которых нет в твоей базе.",
            "parameters": {
                "type": "object",
                "properties": {
                    "query": {
